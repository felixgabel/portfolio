<!-- Adapted from Anthony Fu (MIT License): https://github.com/antfu/antfu.me/blob/main/src/components/ArtPlum.vue -->
...
function polar2cart(x = 0, y = 0, r = 0, theta = 0): [x: number, y: number] {
