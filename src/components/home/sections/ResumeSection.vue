...
<template>
  <SectionHeading>Lebenslauf</SectionHeading>
  <div class="flex flex-col gap-4">
    <p>
      ...
      <ExternalLink href="https://www.typescriptlang.org/">TypeScript</ExternalLink>, jedoch bin ich
      immer bestrebt, mein Wissen zu erweitern und neue Technologien zu erlernen.
    </p>
    <p>
      Angefangen hat alles mit Kurzbefehlen auf meinem iPhone: Kleine Automatisierungen wie "Stoppe
      die Musik nach X Minuten". Ein befreundeter Softwareentwickler meinte damals zu mir, dass das
      dem Programmieren gar nicht so unähnlich sei. Das hat mein Interesse geweckt, und kurz darauf
      durfte ich ein Praktikum beginnen, aus dem eine knapp dreijährige Anstellung wurde. In dieser
      Zeit habe ich mit
    ...
    <p>
      ...
      durchzustarten; und dieses Portfolio ist ein Teil davon. Für das Projekt habe ich mich bewusst
      für <ExternalLink href="https://pinia.vuejs.org/">Pinia</ExternalLink> statt Vuex und für
      <ExternalLink href="https://tailwindcss.com/">Tailwind CSS</ExternalLink> statt Vuetify
      entschieden, um mit modernen Ansätzen zu arbeiten, die mir inzwischen einfach besser gefallen.
    </p>
  </div>
</template>
