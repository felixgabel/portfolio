<!-- Adapted from Anthony Fu (MIT License): https://github.com/antfu/antfu.me/blob/main/src/components/ArtDots.vue -->
...
import { effectScope, nextTick, onMounted, onScopeDispose, onUnmounted, useTemplateRef } from 'vue'
...
<template>
  <div class="pointer-events-none fixed inset-0 -z-1 flex size-full dark:invert" ref="el" />
</template>
